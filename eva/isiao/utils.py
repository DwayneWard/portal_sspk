...
def convert_date(date: str = None, format: str = 'month') -> tuple:
    ...
    :param format: Задает необходимый формат для возврата.
    Возможные значения: month (значение по умолчанию), quarter, half_year и year.
    :return: Возвращает кортеж из даты в нужном формате и формат, если была передана дата.
